...
const Card = ({ card }) => {
  ...
  return (
    <div class="">
      ...
      <div class="mt-2 text-white text-center cursor-pointer bg-yellow-500 hover:bg-yellow-300 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-yellow-600 dark:hover:bg-yellow-500 focus:outline-none dark:focus:ring-yellow-300">
        Hold
      </div>
    </div>
  );
